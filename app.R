      ...
      div(
        ...
        div(
          ...
          div(
            ...
            textOutput("textOutput", style = "font-size: 16px;")
          ),
  ...
  generateTextExplanation <- function(selected_name, interval_start, interval_end) {
    ...
    if (selected_name() == "Finley") {
      if (interval_end() == 1882) {
        ...
        explanation <- "From 1882 to 1932, 'Finley' was solely used as a name for male babies. However, it was not very popular"
      } else if (interval_end() == "1982") {
        explanation <- "From 1932 to 1982, 'Finley' continued being used exclusively among male babies but was still relatively unpopular"
      } else if (interval_end() == "2022") {
        explanation <- "Around the late 1900s, 'Finley' started to appear among female babies and started to pick up in popularity for both sexes. It became more popular among female babies than male babies in 2004. In 2017, the name reached its peak for female babies (0.0522%), and in 2022, it was given to 0.0403% of female babies and 0.0361% of male babies"
      }
    } else if (selected_name() == "Blake") {
      if (interval_end() == 1882) {
        explanation <- "Meaning of Blake: Black or pale"
      } else if (interval_end() == "1932") {
        explanation <- "From 1882 to 1932, 'Blake' was solely used as a name for male babies. However, it was not very popular"
      } else if (interval_end() == "1982") {
        explanation <- "Around the 1940s, the name 'Blake' started to increase in popularity among male babies, with a surge in popularity around 1979. On the other hand, 'Blake' was first introduced among female babies in 1951, but its popularity remained relatively low"
      } else if (interval_end() == "2022") {
        explanation <- "Blake reached its peak among male babies in 2012, with 0.165% given this name. However, its popularity declined rapidly after that. In 2022, only 0.00468% of male babies were given this name. On the other hand, 'Blake' began to rise in popularity among female babies around 2007. In 2022, it was given to 0.00444% of female babies, nearly matching its occurrence among male babies"
      }
      ...
      if (interval_end() == "1882") {
        ...
        explanation <- "Between 1982 to 2022, 'Tatum' started to see an exponential increase among both sexes. In 2022, 0.0342% of female babies and 0.0313% of male babies were given this name"
      }
    } else if (selected_name() == "Charlie") {
      if (interval_end() == "1882") {
        explanation <- "Meaning of Charlie: Free man"
      } else if (interval_end() == "1932") {
        explanation <- "The name 'Charlie' spans back to the 1880s. It was highly popular among male babies during this period. In 1883, 0.296% of male babies were given this name. However, its popularity declined over the years. In 1932, 0.101% of male babies were given this name. Conversely, although 'Charlie' was also given to female babies during this period, it was not popular. In 1932, only 0.00763% of female babies were given this name."
      } else if (interval_end() == "1982") {
        explanation <- "Between 1932 to 1982, the name 'Charlie' continued to decrease in popularity among male babies while it remained relatively unpopular among female babies"
      } else if (interval_end() == "2022") {
        explanation <- "'Charlie' started regaining its popularity among both sexes somewhere around the late 1900s. Its popularity among female babies overtook male babies around 2016. In 2022, more female babies were given this name (0.0624%) than male babies (0.0691%)"
      }
      ...
      if (interval_end() == "1882") {
        ...
        explanation <- "This name was first introduced for both sexes around the mid 1980s and saw a rise in popularity since its introduction. In 2022, 0.000236% of male babies and 0.000209% of female babies were given this name"
      }
    }
